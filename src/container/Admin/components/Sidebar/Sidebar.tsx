  ...
  return (
    <div className="bg-white w-64 h-screen p-6">
      <div className="space-y-4">
        <div className="text-base text-gray-500">GENERAL</div>
        <a
          href="#"
          className="flex items-center p-2 text-gray-700 rounded-lg hover:bg-green-100 bg-green-100"
        >
      ...
      <div className="mt-8 space-y-4">
        <div className="text-base text-gray-500">HELP & SETTINGS</div>
        <a
          href="#"
          className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-50"
        >
          <i>
            <svg
              xmlns="http://www.w3.org/2000/svg"
