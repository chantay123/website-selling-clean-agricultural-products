...
const CategoryAdmin = () => {
    ...
    const deleteCategory = async (product_id: any) => {
        console.log(product_id);
        try {
            await requestApi(`categories/${product_id}`, "DELETE", {},
                {
                    Authorization: `Bearer ${access_token}`,
                }
            );
    ...
    const extendedList: CategoryType[] = list.map((obj, index) => ({
        ...obj,
        key: `key-${index}`,
    }));
    const columns: TableProps<CategoryType>["columns"] = [
        ...
        },
        {
            ...
            render: (attributes: CategoryType[], categorytype) => (
                <Space size="middle">
                    <button
    ...
    const data: CategoryType[] = extendedList;
